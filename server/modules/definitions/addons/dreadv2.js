...
module.exports = ({ Class }) => {
  ...
  return console.log(
    "--- Dreadnoughts v2 addon [dreadv2.js] is disabled. See lines 60-61 to enable it. ---",
  );
  ...
  Class.gladiatorOfficialV2.GUNS[1].PROPERTIES.TYPE =
    "gladiatorTritankMinionOfficialV2";
  Class.gladiatorOfficialV2.GUNS[4].PROPERTIES.TYPE =
    "gladiatorTritrapMinionOfficialV2";
  Class.gladiatorOfficialV2.GUNS[7].PROPERTIES.TYPE =
    "gladiatorTriswarmMinionOfficialV2";
  Class.gladiatorOfficialV2.GUNS[10].PROPERTIES.TYPE =
    "gladiatorAutoMinionOfficialV2";
  Class.gladiatorOfficialV2.GUNS[13].PROPERTIES.TYPE =
    "gladiatorAuraMinionOfficialV2";
  ...
  Class.leviathanOfficialV2 = {
    ...
    TURRETS: [
      ...
      },
      {
        POSITION: [20, 0, 0, 0, 0, 0],
        TYPE: [
          "pentagonLeviathanBottomOfficialV2",
          { MIRROR_MASTER_ANGLE: true },
        ],
      },
    ],
  ...
  Class.supernovaOfficialV2.UPGRADES_TIER_0 = [
    makeHexnoughtBodyV2("supernovaOfficialV2"),
  ];
  ...
  Class.interstellarOfficialV2.UPGRADES_TIER_0 = [
    makeHexnoughtBodyV2("interstellarOfficialV2"),
  ];
  ...
  Class.photosphereOfficialV2.UPGRADES_TIER_0 = [
    makeHexnoughtBodyV2("photosphereOfficialV2"),
  ];
  // Class.fusionOfficialV2.UPGRADES_TIER_0 = ["supernovaOfficialV2"];
  // Class.trojanOfficialV2.UPGRADES_TIER_0 = ["malwareOfficialV2"];
  Class.planetOfficialV2.UPGRADES_TIER_0 = ["astronomicOfficialV2"];
  Class.astronomicOfficialV2.UPGRADES_TIER_0 = [
    makeHexnoughtBodyV2("astronomicOfficialV2"),
  ];
  ...
  Class.stratosphereOfficialV2.UPGRADES_TIER_0 = [
    makeHexnoughtBodyV2("stratosphereOfficialV2"),
  ];
  // Class.exosphereOfficialV2.UPGRADES_TIER_0 = ["interstellarOfficialV2"];
  // Class.hardwareOfficialV2.UPGRADES_TIER_0 = ["softwareOfficialV2"];
  Class.moonOfficialV2.UPGRADES_TIER_0 = ["grandioseOfficialV2"];
  Class.grandioseOfficialV2.UPGRADES_TIER_0 = [
    makeHexnoughtBodyV2("grandioseOfficialV2"),
  ];
  ...
  Class.colossalOfficialV2.UPGRADES_TIER_0 = [
    "titanOfficialV2",
    "sirenOfficialV2",
    "harpyOfficialV2",
  ];
  Class.titanOfficialV2.UPGRADES_TIER_0 = ["leviathanOfficialV2"];
  Class.leviathanOfficialV2.UPGRADES_TIER_0 = [
    makeHexnoughtBodyV2("leviathanOfficialV2"),
  ];
  ...
  function mergeHexnoughtWeaponV2(weapon1, weapon2) {
    ...
    if (weapon1.GUNS)
      gunsOnOneSide.push(
        ...JSON.parse(
          JSON.stringify(weapon1.GUNS.slice(0, weapon1.GUNS.length / 5)),
        ),
      );
    if (weapon2.GUNS)
      weapon2GunsOnOneSide = JSON.parse(
        JSON.stringify(weapon2.GUNS.slice(0, weapon2.GUNS.length / 5)),
      );

    for (let g in weapon2GunsOnOneSide)
      weapon2GunsOnOneSide[g].POSITION[5] += 60;
  ...
  function makeHexnoughtBodyV2(body) {
    ...
    if (body.GUNS)
      gunsOnOneSide.push(
        ...JSON.parse(
          JSON.stringify(body.GUNS.slice(0, (body.GUNS.length / 5) * 2)),
        ),
      );
    for (let g in gunsOnOneSide) {
