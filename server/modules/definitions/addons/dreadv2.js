  ...
  GUNS: [
    {
      ...
      PROPERTIES: {
        SHOOT_SETTINGS: combineStats([
          ...
          g.flankGuard,
          g.autoTurret,
          { reload: 1.1, health: 0.9, damage: 0.8, recoil: 0.2 },
        ]),
        TYPE: "bullet",
      },
    },
  ...
  GUNS: weaponArray(
    {
      ...
      PROPERTIES: {
        SHOOT_SETTINGS: combineStats([
          g.basic,
          { speed: 0.9, maxSpeed: 0.9, health: 1.15 },
        ]),
        TYPE: "bullet",
      },
    },
  ...
  GUNS: [
    {
      ...
      PROPERTIES: {
        SHOOT_SETTINGS: combineStats([
          ...
          g.power,
          g.turret,
          { health: 1.2, speed: 0.85, recoil: 1.15 },
        ]),
        TYPE: "bullet",
      },
    },
      ...
      },
      {
        ...
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([
            ...
            g.sniper,
            g.rifle,
            { speed: 1.05, maxSpeed: 1.05, health: 1.12 },
          ]),
          TYPE: "bullet",
        },
      },
  ...
  GUNS: weaponArray(
    {
      ...
      PROPERTIES: {
        SHOOT_SETTINGS: combineStats([
          g.basic,
          g.machineGun,
          { size: 0.8, speed: 0.85, maxSpeed: 0.85, health: 1.23 },
        ]),
        TYPE: "bullet",
      },
    },
  ...
  GUNS: [
    {
      ...
      PROPERTIES: {
        SHOOT_SETTINGS: combineStats([
          ...
          g.turret,
          g.assassin,
          { health: 1.24, speed: 0.77, recoil: 1.15 },
        ]),
        TYPE: "bullet",
      },
    },
      ...
      },
      {
        ...
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([
            ...
            g.rifle,
            g.twin,
            { speed: 1.09, maxSpeed: 1.09, health: 1.15 },
          ]),
          TYPE: "bullet",
        },
      },
    ...
    [
      {
        ...
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([
            ...
            g.assassin,
            g.assassin,
            { reload: 1.05, health: 0.98, density: 0.45 },
          ]),
          TYPE: "bullet",
        },
      },
      ...
      },
      {
        ...
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([
            ...
            g.twin,
            g.spam,
            { size: 0.8, health: 0.66, reload: 1.1 },
          ]),
          TYPE: "bullet",
        },
      },
    ...
    [
      {
        ...
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([
            ...
            g.overseer,
            g.overseer,
            { maxSpeed: 0.9, size: 1.5, reload: 0.9 },
          ]),
          TYPE: "drone",
          MAX_CHILDREN: 2,
          AUTOFIRE: true,
      ...
      },
      {
        ...
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([
            ...
            g.overseer,
            g.pounder,
            { damage: 0.85, maxSpeed: 0.9, size: 2, reload: 0.8 },
          ]),
          TYPE: "betadrone",
          MAX_CHILDREN: 2,
          AUTOFIRE: true,
  ...
  GUNS: weaponArray(
    {
      ...
      PROPERTIES: {
        SHOOT_SETTINGS: combineStats([
          ...
          g.assassin,
          g.minionGun,
          { speed: 1.06, maxSpeed: 1.06, reload: 1.8, health: 1.25 },
        ]),
        WAIT_TO_CYCLE: true,
        TYPE: "bullet",
      },
  ...
  GUNS: [
    {
      ...
      PROPERTIES: {
        SHOOT_SETTINGS: combineStats([
          ...
          g.assassin,
          g.pounder,
          { health: 1.18, speed: 0.73, recoil: 1.15 },
        ]),
        TYPE: "bullet",
      },
    },
      ...
      },
      {
        ...
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([
            ...
            g.rifle,
            g.twin,
            { speed: 1.13, maxSpeed: 1.13, health: 1.21 },
          ]),
          TYPE: "bullet",
        },
      },
    ...
    [
      {
        ...
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([
            ...
            g.assassin,
            g.assassin,
            { reload: 1.13, health: 1.12, density: 0.55 },
          ]),
          TYPE: "bullet",
        },
      },
      ...
      },
      {
        ...
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([
            ...
            g.spam,
            g.spam,
            { size: 0.7, health: 0.64, reload: 1.1 },
          ]),
          TYPE: "bullet",
        },
      },
      {
        ...
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([
            ...
            g.spam,
            g.spam,
            { size: 0.7, health: 0.64, reload: 1.2 },
          ]),
          TYPE: "bullet",
        },
      },
      ...
      },
      {
        ...
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([
            ...
            g.overseer,
            g.pounder,
            { damage: 1.04, maxSpeed: 0.9, size: 2, reload: 1.05 },
          ]),
          TYPE: "betadrone",
          MAX_CHILDREN: 1,
          AUTOFIRE: true,
  ...
  GUNS: weaponArray(
    {
      ...
      PROPERTIES: {
        SHOOT_SETTINGS: combineStats([
          ...
          g.assassin,
          g.minionGun,
          { speed: 1.06, maxSpeed: 1.06, reload: 1.8, health: 1.3 },
        ]),
        WAIT_TO_CYCLE: true,
        TYPE: ["bullet", { COLOR: 5 }],
      },
      ...
      },
      {
        ...
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([
            ...
            g.flankGuard,
            g.minionGun,
            { reload: 1.2, speed: 0.8, maxSpeed: 0.8 },
          ]),
          TYPE: "trap",
          STAT_CALCULATOR: gunCalcNames.trap,
        },
  ...
  GUNS: weaponArray(
    {
      ...
      PROPERTIES: {
        SHOOT_SETTINGS: combineStats([
          ...
          g.flankGuard,
          g.minionGun,
          { speed: 1.1, maxSpeed: 1.1, reload: 1.6, size: 1.6, range: 1.15 },
        ]),
        TYPE: ["swarm", { COLOR: 5 }],
  ...
  GUNS: [
    {
      ...
      PROPERTIES: {
        SHOOT_SETTINGS: combineStats([
          ...
          g.pounder,
          g.destroyer,
          { health: 1.05, speed: 0.7, recoil: 1.15 },
        ]),
        TYPE: "bullet",
      },
    },
...
Class.dreadWeaponOfficialV2.UPGRADES_TIER_0 = [
  "swordOfficialV2",
  "pacifierOfficialV2",
...
Class.swordOfficialV2.UPGRADES_TIER_0 = [
  "gladiusOfficialV2",
  "sabreOfficialV2",
];
...
Class.pacifierOfficialV2.UPGRADES_TIER_0 = [
  "mediatorOfficialV2",
  "negotiatorOfficialV2",
];
...
Class.peacekeeperOfficialV2.UPGRADES_TIER_0 = [
  "enforcerOfficialV2",
  "executorOfficialV2",
];
...
Class.invaderOfficialV2.UPGRADES_TIER_0 = [
  "inquisitorOfficialV2",
  "assailantOfficialV2",
];
...
Class.centaurOfficialV2.UPGRADES_TIER_0 = [
  "daemonOfficialV2",
  "minotaurOfficialV2",
];
...
Class.dreadBodyOfficialV2.UPGRADES_TIER_0 = [
  "byteOfficialV2",
  "atmosphereOfficialV2",
  "juggernautOfficialV2",
];

Class.byteOfficialV2.UPGRADES_TIER_0 = [
  "automationOfficialV2",
  "kilobyteOfficialV2",
];

Class.automationOfficialV2.UPGRADES_TIER_0 = [
  "mechanismOfficialV2",
  "fusionOfficialV2",
  "binaryOfficialV2",
  "exosphereOfficialV2",
...
Class.skynetOfficialV2.UPGRADES_TIER_0 =
  makeHexnoughtBodyV2("skynetOfficialV2");
Class.fusionOfficialV2.UPGRADES_TIER_0 = ["supernovaOfficialV2"];
Class.supernovaOfficialV2.UPGRADES_TIER_0 = makeHexnoughtBodyV2(
  "supernovaOfficialV2",
);
Class.binaryOfficialV2.UPGRADES_TIER_0 = ["cipherOfficialV2"];
Class.cipherOfficialV2.UPGRADES_TIER_0 =
  makeHexnoughtBodyV2("cipherOfficialV2");
Class.exosphereOfficialV2.UPGRADES_TIER_0 = ["interstellarOfficialV2"];
Class.interstellarOfficialV2.UPGRADES_TIER_0 = makeHexnoughtBodyV2(
  "interstellarOfficialV2",
);

Class.kilobyteOfficialV2.UPGRADES_TIER_0 = [
  "megabyteOfficialV2",
  "binaryOfficialV2",
  "trojanOfficialV2",
  "hardwareOfficialV2",
...
Class.gigabyteOfficialV2.UPGRADES_TIER_0 =
  makeHexnoughtBodyV2("gigabyteOfficialV2");
// Class.binaryOfficialV2.UPGRADES_TIER_0 = ["cipherOfficialV2"];
Class.trojanOfficialV2.UPGRADES_TIER_0 = ["malwareOfficialV2"];
Class.malwareOfficialV2.UPGRADES_TIER_0 =
  makeHexnoughtBodyV2("malwareOfficialV2");
Class.hardwareOfficialV2.UPGRADES_TIER_0 = ["softwareOfficialV2"];
Class.softwareOfficialV2.UPGRADES_TIER_0 =
  makeHexnoughtBodyV2("softwareOfficialV2");

Class.atmosphereOfficialV2.UPGRADES_TIER_0 = [
  "coronaOfficialV2",
  "thermosphereOfficialV2",
];

Class.coronaOfficialV2.UPGRADES_TIER_0 = [
  "chromosphereOfficialV2",
  "fusionOfficialV2",
  "trojanOfficialV2",
  "planetOfficialV2",
];
Class.chromosphereOfficialV2.UPGRADES_TIER_0 = ["photosphereOfficialV2"];
Class.photosphereOfficialV2.UPGRADES_TIER_0 = makeHexnoughtBodyV2(
  "photosphereOfficialV2",
);
// Class.fusionOfficialV2.UPGRADES_TIER_0 = ["supernovaOfficialV2"];
// Class.trojanOfficialV2.UPGRADES_TIER_0 = ["malwareOfficialV2"];
Class.planetOfficialV2.UPGRADES_TIER_0 = ["astronomicOfficialV2"];
Class.astronomicOfficialV2.UPGRADES_TIER_0 = makeHexnoughtBodyV2(
  "astronomicOfficialV2",
);

Class.thermosphereOfficialV2.UPGRADES_TIER_0 = [
  "mesosphereOfficialV2",
  "exosphereOfficialV2",
  "hardwareOfficialV2",
  "moonOfficialV2",
];
Class.mesosphereOfficialV2.UPGRADES_TIER_0 = ["stratosphereOfficialV2"];
Class.stratosphereOfficialV2.UPGRADES_TIER_0 = makeHexnoughtBodyV2(
  "stratosphereOfficialV2",
);
// Class.exosphereOfficialV2.UPGRADES_TIER_0 = ["interstellarOfficialV2"];
// Class.hardwareOfficialV2.UPGRADES_TIER_0 = ["softwareOfficialV2"];
Class.moonOfficialV2.UPGRADES_TIER_0 = ["grandioseOfficialV2"];
Class.grandioseOfficialV2.UPGRADES_TIER_0 = makeHexnoughtBodyV2(
  "grandioseOfficialV2",
);

Class.juggernautOfficialV2.UPGRADES_TIER_0 = [
  "jumboOfficialV2",
  "colossusOfficialV2",
];

Class.jumboOfficialV2.UPGRADES_TIER_0 = [
  "goliathOfficialV2",
  "planetOfficialV2",
  "moonOfficialV2",
];
Class.goliathOfficialV2.UPGRADES_TIER_0 = ["behemothOfficialV2"];
Class.behemothOfficialV2.UPGRADES_TIER_0 =
  makeHexnoughtBodyV2("behemothOfficialV2");
// Class.planetOfficialV2.UPGRADES_TIER_0 = ["astronomicOfficialV2"];
// Class.moonOfficialV2.UPGRADES_TIER_0 = ["grandioseOfficialV2"];

Class.colossusOfficialV2.UPGRADES_TIER_0 = [
  "titanOfficialV2",
  "sirenOfficialV2",
  "harpyOfficialV2",
];
Class.titanOfficialV2.UPGRADES_TIER_0 = ["leviathanOfficialV2"];
Class.leviathanOfficialV2.UPGRADES_TIER_0 = makeHexnoughtBodyV2(
  "leviathanOfficialV2",
);
Class.sirenOfficialV2.UPGRADES_TIER_0 = ["valrayvnOfficialV2"];
Class.valrayvnOfficialV2.UPGRADES_TIER_0 =
  makeHexnoughtBodyV2("valrayvnOfficialV2");
Class.harpyOfficialV2.UPGRADES_TIER_0 = ["pegasusOfficialV2"];
Class.pegasusOfficialV2.UPGRADES_TIER_0 =
  makeHexnoughtBodyV2("pegasusOfficialV2");
...
function mergeHexnoughtWeaponV2(weapon1, weapon2) {
  ...
  if (name1) {
    ...
    (weaponName = name2), (orientationId = 1);
  }
  let LABEL = weaponName,
    className =
      weapon1.LABEL.toLowerCase() +
      weapon2.LABEL +
      orientationId +
      "OfficialV2";
  ...
  for (let t in weapon2TurretsOnOneSide)
    weapon2TurretsOnOneSide[t].POSITION[3] += 60;
  ...
  if (body.TURRETS) {
    ...
    for (let t = 0; t < body.TURRETS.length; t++) {
      ...
      if (turret.POSITION[1]) {
        // Do whole turret loop at once
        for (let i = 0; i < turretRingLoopLength; i++) {
          for (let j = 0; j < 6; j++) {
            turret = body.TURRETS[t + i * 5 + 1];
            TURRETS.push({
              POSITION: [
                turret.POSITION[0] * hexnoughtScaleFactor,
                turret.POSITION[1] * hexnoughtScaleFactor ** 0.5,
                turret.POSITION[2],
                (turret.POSITION[3] / 6) * 5 + 60 * j,
                turret.POSITION[4],
                turret.POSITION[5],
              ],
              TYPE: turret.TYPE,
        ...
        TURRETS.push({
          POSITION: [
            turret.POSITION[0] * hexnoughtScaleFactor ** 0.5,
            0,
            0,
            turret.POSITION[3],
            turret.POSITION[4],
