...
Class.megaTornadoDeco = makeDeco([
  [0, -1],
  [0.5, 0],
  [0, 1],
  [-0.5, 0],
...
Class.tempestDeco1.CONTROLLERS = [
  ["spin", { independent: true, speed: 0.128 }],
];
Class.tempestDeco2 = makeDeco(3);
Class.tempestDeco2.CONTROLLERS = [
  ["spin", { independent: true, speed: -0.128 }],
];
Class.thunderboltDeco = makeDeco(4);
Class.thunderboltDeco.CONTROLLERS = [
  ["spin", { independent: true, speed: 0.16 }],
];
Class.hurricaneDeco = makeDeco(8);
Class.hurricaneDeco.CONTROLLERS = [
  ["spin", { independent: true, speed: 0.128 }],
];
...
Class.blizzardDeco1.CONTROLLERS = [
  ["spin", { independent: true, speed: 0.128 }],
];
Class.blizzardDeco2 = makeDeco(5);
Class.blizzardDeco2.CONTROLLERS = [
  ["spin", { independent: true, speed: -0.128 }],
];
    ...
    for (let i = 0; i < 3; i++) {
      output.push({
        ...
        PROPERTIES: {
          ...
          TYPE: [
            "satellite",
            { ANGLE: i * 120, CONTROLLERS: [["orbit", { invert: true }]] },
          ],
          MAX_CHILDREN: 1,
          AUTOFIRE: true,
          SYNCS_SKILLS: false,
    ...
    for (let i = 0; i < 5; i++) {
      output.push({
        ...
        PROPERTIES: {
          ...
          TYPE: [
            "satellite",
            { ANGLE: i * 72, CONTROLLERS: [["orbit", { invert: true }]] },
          ],
          MAX_CHILDREN: 1,
          AUTOFIRE: true,
          SYNCS_SKILLS: false,
...
Class.latDeco1 = {
  ...
  COLOR: "#5C533F",
  SHAPE:
    "M -1 -2 C -1 -2 -1 -3 0 -3 C 1 -3 1 -2 1 -2 V 2 C 1 2 1 3 0 3 C -1 3 -1 2 -1 2 V -2",
  ...
  GUNS: [
    ...
    },
    {
      ...
      PROPERTIES: {
        SHOOT_SETTINGS: combineStats([
          g.basic,
          { reload: 3, damage: 1.2, shudder: 0.5 },
        ]),
...
Class.dailyTanks.UPGRADES_TIER_0 = [
  "whirlwind",
  "master",
  "undertow",
...
if (addToMain == true) {
  ...
  Class.basic.UPGRADES_TIER_3 = ["whirlwind"];
}
