...
Class.auto3 = makeRadialAuto("autoTankGun", {
  isTurret: true,
  danger: 6,
  label: "Auto-3",
});
...
// Auto-3 upgrades
Class.auto5 = makeRadialAuto("autoTankGun", {
  isTurret: true,
  danger: 7,
  label: "Auto-5",
  count: 5,
});
Class.mega3 = makeRadialAuto("megaAutoTankGun", {
  isTurret: true,
  danger: 7,
  size: 14,
  label: "Mega-5",
  body: { SPEED: 0.95 * base.SPEED },
});
Class.auto4 = makeRadialAuto("auto4gun", {
  isTurret: true,
  danger: 7,
  size: 13,
  x: 6,
...
Class.banshee = makeRadialAuto("bansheegun", {
  isTurret: true,
  danger: 7,
  size: 10,
  arc: 80,
      ...
      [
        ...
        },
        {
          ...
          PROPERTIES: {
            SHOOT_SETTINGS: combineStats([
              g.trap,
              { range: 0.5, speed: 0.7, maxSpeed: 0.7 },
            ]),
            TYPE: "trap",
            STAT_CALCULATOR: gunCalcNames.trap,
          },
...
// Builder upgrades
Class.construct = {
  // it's "construct" and not "constructor" because "constructor" breaks things
  PARENT: "genericTank",
  LABEL: "Constructor",
  STAT_NAMES: statnames.trap,
  DANGER: 7,
  ...
  GUNS: [
    ...
    },
    {
      ...
      PROPERTIES: {
        ...
        TYPE: [
          "bullet",
          { MOTION_TYPE: ["desmos", { period: 7, amplitude: 12.5 }] },
        ],
      },
    },
    {
      ...
      PROPERTIES: {
        ...
        TYPE: [
          "bullet",
          {
            MOTION_TYPE: [
              "desmos",
              { period: 7, amplitude: 12.5, invert: true },
            ],
          },
        ],
      },
...
// Hybrid tanks
Class.bentHybrid = makeOver("tripleShot", "Bent Hybrid", {
  count: 1,
  independent: true,
  cycle: false,
});
Class.poacher = makeOver("hunter", "Poacher", {
  count: 1,
  independent: true,
  cycle: false,
});
Class.armsman = makeOver("rifle", "Armsman", {
  count: 1,
  independent: true,
  cycle: false,
});
Class.cropDuster = makeOver("minigun", "Crop Duster", {
  count: 1,
  independent: true,
  cycle: false,
});
Class.hybrid = makeOver("destroyer", "Hybrid", {
  count: 1,
  independent: true,
  cycle: false,
});
...
Class.autoSmasher = makeAuto(
  ...
  "Auto-Smasher",
  { type: "autoSmasherTurret", size: 11 },
);
...
Class.annihilator.UPGRADES_TIER_3 = ["bigmac", "ak46"];
...
Class.bentDouble.UPGRADES_TIER_3 = ["crab"];
...
Class.single.UPGRADES_TIER_3 = ["mechsingle"];
...
Class.dual.UPGRADES_TIER_3 = ["dualator"];
Class.musket.UPGRADES_TIER_3 = ["dualator"];
Class.rifle.UPGRADES_TIER_3 = ["musket", "crossbow", "armsman"];
Class.booster.UPGRADES_TIER_3 = ["master"];
...
Class.streamliner.UPGRADES_TIER_3 = ["baba", "machineliner"];
...
Class.hexaTank.UPGRADES_TIER_3 = ["octoTank", "hexaTrapper", "cyclone"];
Class.octoTank.UPGRADES_TIER_3 = ["flankest"];
...
Class.vulture.UPGRADES_TIER_3 = ["joker"];
...
Class.bigCheese.UPGRADES_TIER_3 = ["biggerCheese", "overcheese"];
...
Class.overlord.UPGRADES_TIER_3 = ["captain"];
...
Class.necromancer.UPGRADES_TIER_3 = ["triamancer", "mummifier", "pentamancer"];
...
Class.spike.UPGRADES_TIER_3 = ["boxer"];
Class.shotgun.UPGRADES_TIER_3 = ["shotgunner"];
Class.destroyer.UPGRADES_TIER_3 = ["overdestroy", "jerker"];

Class.launcher.UPGRADES_TIER_3 = ["rocketeer", "missler"];
//Class.twister.UPGRADES_TIER_3 = ["twisty"];
Class.builder.UPGRADES_TIER_3 = ["assembler", "microscope", "beetle"];
Class.construct.UPGRADES_TIER_3 = ["assemblerbutbig"];
Class.trapGuard.UPGRADES_TIER_3 = ["bomber", "twintrap"];
Class.nailgun.UPGRADES_TIER_3 = ["nailer"];

Class.helix.UPGRADES_TIER_3 = ["triplex", "quadruplex"];
Class.triplet.UPGRADES_TIER_3 = ["ak46"];
Class.architect.UPGRADES_TIER_3 = ["trinuke"];
Class.helix.UPGRADES_TIER_3 = ["triplex", "quadruplex"];
Class.triplet.UPGRADES_TIER_3 = ["ak46"];
Class.architect.UPGRADES_TIER_3 = ["trinuke"];
