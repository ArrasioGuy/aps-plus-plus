...
exports.ghoster_ghostForm = {
  PARENT: ["genericTank"],
  TOOLTIP:
    "You are now in ghost form, roam around and find your next target. Will turn back in 5 seconds",
  LABEL: "Ghoster",
  BODY: {
    SPEED: 20,
    ACCELERATION: 10,
...
exports.whirlwindDeco.CONTROLLERS = [
...
exports.bromycatslipped = {
  PARENT: "genericTank",
  LABEL: "Bro my cat slipped",
  GUNS: [
    {
      POSITION: [18, 8, 1, 0, 0, 24.5, 0],
      PROPERTIES: {
        SHOOT_SETTINGS: combineStats([g.basic]),
        TYPE: "bullet",
      },
...
exports.elites.UPGRADES_TIER_0 = [
  "eliteDestroyer",
  "eliteGunner",
  "eliteSprayer",
  "eliteBattleship",
...
exports.mysticals.UPGRADES_TIER_0 = [
  "sorcerer",
  "summoner",
  "enchantress",
  "exorcistor",
...
exports.rogues.UPGRADES_TIER_0 = [
  "roguePalisade",
  "rogueArmada",
  "julius",
  "genghis",
...
exports.terrestrials.UPGRADES_TIER_0 = [
  "ares",
  "gersemi",
  "ezekiel",
  "eris",
...
exports.celestials.UPGRADES_TIER_0 = [
  "paladin",
  "freyja",
  "zaphkiel",
  "nyx",
...
exports.devBosses.UPGRADES_TIER_0 = [
  "taureonBoss",
  "zenphiaBoss",
  "dogeiscutBoss",
  "trplnrBoss",
...
exports.overpowered.UPGRADES_TIER_0 = [
  "armyOfOne",
  "godbasic",
  "maximumOverdrive",
];
