...
class Gun {
    ...
    if (info.PROPERTIES != null) {
      ...
      if (info.PROPERTIES.COLOR != null) {
        if (
          ...
          if (
            (!isNaN(info.PROPERTIES.COLOR) &&
              !isNaN(parseFloat(info.PROPERTIES.COLOR))) ||
            /^[a-zA-Z]*$/.test(info.PROPERTIES.COLOR)
          )
  ...
  fire(gx, gy, sk) {
    ...
    if (this.independentChildren) {
      ...
      o.life();
      this.altFire
        ? this.master.ON(undefined, "altFire", {
            gun: this,
            store: this.store,
            globalStore: this.globalStore,
            child: o,
          })
        : this.master.ON(undefined, "fire", {
            gun: this,
            store: this.store,
            globalStore: this.globalStore,
            child: o,
